...
const DoctorDashboard = () => {
    ...
    // Define navigation buttons for the main dashboard
    const navigationButtons = [
        { name: 'Patients', link: '/patients' },
        { name: 'Medical Records', link: '/healthrecords' },
        { name: 'Appointments', link: '/appointments' },
    ...
    // Define quick access buttons specific to doctors
    const doctorQuickAccessButtons = [
        { name: 'Patient Records', link: '/patients' },
        { name: 'Appointment Schedule', link: '/appointments' },
        { name: 'Prescription Management', link: '/prescriptions' },
        { name: 'Lab Results', link: '/lab-results' }
    ];
    ...
    return (
        <div style={backgroundStyle}>
            ...
            {/* Quick Access Buttons for doctors */}
            <QuickAccessButtons buttons={doctorQuickAccessButtons} />
