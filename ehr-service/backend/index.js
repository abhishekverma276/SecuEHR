...
// Comment out or remove this if you don't need MongoDB for login
...
app.post('/api/auth/password-request', async (req, res) => {
  try {
    const response = await axios.post('http://localhost:3000/auth/password-request', req.body, {
...
// Proxy login route to Auth Service
